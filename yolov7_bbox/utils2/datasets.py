...
from utils2.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
    resample_segments, clean_str
from utils2.torch_utils import torch_distributed_zero_first
from torchvision.transforms import Compose, Normalize, RandomHorizontalFlip, RandomResizedCrop, ToTensor, Resize, Lambda, RandomVerticalFlip, ToPILImage
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        #    ]
        #)
        #img = transform(torch.from_numpy(img).to(torch.float32))
